...
(async () => {
  try {
    ...
    const note = enc.encode("My first transaction on Algo!"); let amount = 100000; // equals .1 ALGO
...
algodClient.accountInformation(myaccount.addr).do();
    ...
    console.log("Account balance: %d microAlgos", accountInfo.amount);}catch (err) {
