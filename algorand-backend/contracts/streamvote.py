...
if __name__ == "__main__":
    ...
    with open(os.path.join(path, "streamvote_approval.teal"), 'w') as f:f.write(approval_program())

    with open(os.path.join(path, "streamvote_clear.teal"), 'w') as f:f.write(clear_state_program())